...
public class Contactos extends AppCompatActivity{
    ...
    public void buscarTodosContactos(Context context) {
        JSONArray arr = new JSONArray();
        final StringBuilder resultado = new StringBuilder();
        Uri uri = ContactsContract.Contacts.CONTENT_URI;
        String sortOrder = ContactsContract.Contacts.DISPLAY_NAME + " COLLATE LOCALIZED ASC";
        ...
        // consulta ejemplo buscando por nombre visualizado en los contactos agregados
        Cursor c = context.getContentResolver().query(uri, null, ContactsContract.Contacts.DISPLAY_NAME, null, sortOrder);
        int count = c.getColumnCount();
        int fila = 0;
        String[] columnas = new String[count];
        try {
